...
export default function ManualHeaderContent({ dictionary, headerLabelKey }) {
    return (
        <>
        <header className="relative mb-6 h-60 sm:h-80 xl:h-96 rounded-3xl overflow-hidden">
            <div
                className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat manuals-header rounded-3xl"
                aria-hidden="true"
            />
            <div className="relative z-10 flex h-full flex-col items-center justify-center p-4 text-center text-white">
                <h1 className="text-2xl font-bold sm:text-4xl xl:text-5xl mb-4">
                    
                    {dictionary.manuals[headerLabelKey]}
                </h1>
