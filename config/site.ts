...
export const siteConfig = {
  ...
  strollerQuestions : [
    {
      id: 1,
      question: "What type of terrain will you primarily use the stroller on?",
      multipleOptionsAllowed: false,
      options: [
        { name: "only-city", label: "main-card.chip.only-city" }, // City streets
        { name: "all-terrain", label: "main-card.chip.all-terrain" }, // Mixed terrain (city + off-road)
        { name: "around-the-world", label: "main-card.chip.around-the-world" } // Off-road only
      ],
    },
    {
      id: 4,
      question: "Do you need a lightweight stroller?",
      multipleOptionsAllowed: false,
      options: [
        { name: "lightweight", label: "main-card.chip.yes" },
        { name: "no", label: "main-card.chip.no" }
      ],
    },
    {
      id: 5,
      question: "Do you need a travel system?",
      multipleOptionsAllowed: false,
      options: [
        { name: "travel-system", label: "main-card.chip.yes" },
        { name: "no", label: "main-card.chip.no" }
      ],
    },
    {
      id: 7,
      question: "What features do you want in the stroller seat?",
      multipleOptionsAllowed: true,
      options: [
        { name: "recliningSeat", label: "main-card.chip.recliningSeat" },
        { name: "reversibleSeat", label: "main-card.chip.reversibleSeat" },
        { name: "suitableForTallKids", label: "main-card.chip.suitableForTallKids" },
        { name: "suitableForChubbyKids", label: "main-card.chip.suitableForChubbyKids" },
        { name: "breathable-mesh", label: "main-card.chip.breathable-mesh" },
        { name: "machine-wash-cold-cycle", label: "main-card.chip.machine-wash-cold-cycle" },
        { name: "only-handwash", label: "main-card.chip.only-handwash" },
        { name: "straight-sit-up", label: "main-card.chip.straight-sit-up" },
        { name: "extendable-seat", label: "main-card.chip.extendable-seat" },
        { name: "height-adjustable-seat", label: "main-card.chip.height-adjustable-seat" }
      ],
    }
  ],  
  carseat_tags: [
  ...
  carSeatQuestions : [
    {
      id: 1,
      question: "What type of base do you prefer for your car seat? (isofix is the default)",
      multipleOptionsAllowed: true,
      options: [
        { name: "baseless-isofix", label: "main-card.chip.baseless-isofix" },
        { name: "base-with-car-seat-belt", label: "main-card.chip.base-with-car-seat-belt" },
        { name: "base-with-belt", label: "main-card.chip.base-with-belt" },
        { name: "no-isofix", label: "main-card.chip.no-isofix" },
        { name: "base-with-easy-in-out-slipping", label: "main-card.chip.base-with-easy-in-out-slipping" },
        { name: "adjustable-base", label: "main-card.chip.adjustable-base" },
      ],
    },
    {
      id: 3,
      question: "What age group do you search for?",
      multipleOptionsAllowed: true,
      options: [
        { name: "baby", label: "main-card.chip.baby" },
        { name: "toddler", label: "main-card.chip.toddler" },
        { name: "kid", label: "main-card.chip.kid" },
      ],
    },
    {
      id: 4,
      question: "What type of seat features do you prioritize?",
      multipleOptionsAllowed: true,
      options: [
        { name: "carrycot", label: "main-card.chip.carrycot" },
        { name: "breathable-mesh", label: "main-card.chip.breathable-mesh" },
        { name: "toddler-seat-on-stroller", label: "main-card.chip.toddler-seat-on-stroller" },
        { name: "machine-washable", label: "main-card.chip.machine-washable" },
        { name: "rotating", label: "main-card.chip.rotating" },
        { name: "full-lie-flat", label: "main-card.chip.full-lie-flat" },
        { name: "lie-flat-in-car", label: "main-card.chip.lie-flat-in-car" },
        { name: "close-lie-flat", label: "main-card.chip.close-lie-flat" },
        { name: "one-hand-rotation", label: "main-card.chip.one-hand-rotation" },
      ],
    }
  ]  
};
